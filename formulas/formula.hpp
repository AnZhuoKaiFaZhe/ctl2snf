//
// Created by mzy on 2021-06-09.
//

#ifndef CTL2SNF_FORMULA_HPP
#define CTL2SNF_FORMULA_HPP
#include <stdio.h>
#include <iostream>
#include <fstream>
...
// CTL Formula representation
    ...
    enum SNFOp { Index, True, NEG, OR, AND, EX, EF, EG, EW, EU, AX, AF, AG, AW, AU};
    ...
    struct CTLFormula {
        ...
        CTLFormula(SNFOp op, CTLFormula * op1, CTLFormula * op2=nullptr,int value =0):op(op),operand1(op1),operand2(op2),value(value){

        }
        CTLFormula(SNFOp op, CTLFormula * op1, CTLFormula * op2, int value, std::vector<CTLFormula *> fairnessConstraints):op(op),operand1(op1),operand2(op2),value(value),fairnessConstraints(fairnessConstraints){
